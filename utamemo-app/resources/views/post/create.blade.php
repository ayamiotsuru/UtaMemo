    ...
    <div class="max-w-7xl mx-auto px-6 pb-24">
        <form method="post" action="{{ route('post.store') }}">
            ...
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="song" class="w-auto pu-2 border border-gray-300 rounded-md"
                        id="song" value="{{ old('song') }}" placeholder="例）SnowMan">
                </div>
            </div>
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="artist" class="w-auto pu-2 border border-gray-300 rounded-md" id="artist" value="{{ old('artist') }}" placeholder="例）D.D.">
                </div>
            </div>
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    <label for="pitch" class="font-semibold mt-4 mb-2">音程キー</label>
                    <input type="text" name="pitch" class="w-auto pu-2 border border-gray-300 rounded-md" id="pitch" value="{{ old('pitch') }}" placeholder="例）原曲キー">
                </div>
            </div>
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="tags" class="w-auto pu-2 border border-gray-300 rounded-md" id="tags" value="{{ old('tags') }}" placeholder="カンマで区切って入力してください。例）盛り上がる,お気に入り,アップテンポ">
                </div>
            </div>
            <div class="mt-4">
            ...
            <div class="w-full flex flex-col">
                ...
                <textarea name="comment" id="comment" cols="30" rows="10" class="w-auto py-2 border border-gray-300 rounded-md" placeholder="例）カラオケで歌ったらめっちゃ盛り上がった。ペンライトがあったらもっと盛り上がったかも。">{{ old('comment') }}</textarea>
            </div>
